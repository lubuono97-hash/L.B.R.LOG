...
// Última atualização: 27/04/2026, 13:36:48
...
const GAMES = [
  ...
  },
  {
    ...
    ano:            2025,
    nota:           8.5,
    capa:          "imagens/Doom The Dark Ages.jpg",
    resumo:        "Um prequel brutal que explora as origens medievais do Slayer, focando em um combate mais cadenciado e pesado.",
    analise:       `
      <p>Doom: The Dark Ages recua no tempo para mostrar o Slayer em sua era medieval, trocando a agilidade frenética por uma força bruta avassaladora. É uma prequela que redefine a origem do herói, mergulhando o jogador em uma guerra sombria contra os exércitos do Inferno muito antes dos eventos modernos.</p>
      <p>O combate abandona o ritmo de "puzzle de alta velocidade" de Eternal para abraçar uma cadência mais pesada e deliberada. O novo escudo de serra é a estrela do show, permitindo que o jogador bloqueie ataques e retalie com uma violência mecânica que parece saída de um épico de fantasia brutal.</p>
      <p>As armas mantêm o DNA da id Software, mas com um toque rústico fascinante, como o triturador de crânios que transforma ossos em estilhaços. Cada disparo carrega um peso físico impressionante, onde o impacto nos inimigos é sentido de forma visceral, reforçando a sensação de ser uma força imparável da natureza.</p>
      <p>A escala do mundo é monumental, apresentando batalhas em campo aberto que envolvem dragões mecânicos e mechs gigantescos conhecidos como Atlans. O design de níveis aproveita essa grandiosidade para criar cenários que evocam uma atmosfera de desolação e poder, expandindo o lore de forma orgânica e visual.</p>
      <p>Tecnicamente, o motor id Tech entrega uma fidelidade visual assustadora, com efeitos de luz e partículas que elevam o horror medieval a um patamar cinematográfico. A trilha sonora, agora incorporando tons mais tribais e orquestrais, complementa perfeitamente o som dos metais colidindo e explosões no campo de batalha.</p>
      <p>Como um todo, The Dark Ages prova que a franquia Doom ainda tem fôlego para se reinventar sem perder sua identidade principal. É uma experiência mais suja, pesada e épica que inicia o arco do Slayer com o tipo de maestria técnica e artística que apenas os mestres do FPS conseguem entregar, entretanto pessoalmente falando Doom Eternal ainda continua sendo o meu favorito pela gameplay que na minha visão é mais dinâmica.</p>
    `
  },
  {
    id:            "elden-ring",
